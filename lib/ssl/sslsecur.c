...
SECStatus
SSL_AlertReceivedCallback(PRFileDesc *fd, SSLAlertCallback cb, void *client_data)
{
    sslSocket *ss;
    ...
    ss->alertReceivedCallbackData = client_data;

    return SECSuccess;
}

SECStatus
SSL_AlertSentCallback(PRFileDesc *fd, SSLAlertCallback cb, void *client_data)
{
    sslSocket *ss;
    ...
    ss->alertSentCallbackData = client_data;
