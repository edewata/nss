...
ssl_DupSocket(sslSocket *os)
{
    ...
    if (ss->opt.useSecurity) {
        ...
        ss->alertReceivedCallbackData = os->alertReceivedCallbackData;
        ss->alertSentCallback = os->alertSentCallback;
        ss->alertSentCallbackData = os->alertSentCallbackData;
...
ssl_NewSocket(PRBool makeLocks, SSLProtocolVariant protocolVariant)
{
    ...
    ss->alertReceivedCallbackData = NULL;
    ss->alertSentCallback = NULL;
    ss->alertSentCallbackData = NULL;
